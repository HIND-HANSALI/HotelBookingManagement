    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form method="POST" action="{{route('detailsbook.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row formtype">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('chambre_id') is-invalid  @enderror"
                                            id="chambre_id" name="chambre_id">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            class="form-control datetimepicker @error('checkIn') is-invalid  @enderror"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            class="form-control datetimepicker @error('checkOut') is-invalid  @enderror"
                                            name="checkOut" value="{{old ('checkOut')}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="form-label ">Name</label>
                                    <input type="text" class="form-control shadow-none" value="{{ $user->name }}"
                                        name="userName">
                                </div>
                                <div class="col-md-4">
                                    <label for="form-label ">Phone Number</label>
                                    <input type="text" class="form-control shadow-none" value="{{ $user->phone }}"
                                        name="phoneNum">
                                </div>

                                <div class="col-md-4">
                                    <label for="form-label ">Address</label>
                                    <textarea class="form-control shadow-none" rows="3" value="" id="address"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            class="form-control @error('numberPerson') is-invalid  @enderror"
                                            id="numberPerson" name="numberPerson" value="{{old ('numberPerson')}}">
                                    </div>
                                </div>
