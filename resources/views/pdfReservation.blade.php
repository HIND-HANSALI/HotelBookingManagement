...
<head>
    <title>Hotel Booking Website-Rooms -PDF Booking</title>
    <!-- links section -->
    @include('links')
...
<body>
    <div class="container" >
        <div class="row">
            <div class="col-12">
                <strong>Application Booking:</strong>
                <span>593</span>
            </div>
        </div>
        <hr/>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <span>{{$booking->reservationdetails->numberPerson}}</span>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <span>{{$booking->reservationdetails->total_payement}} MAD</span>
                    </td>
                </tr>
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <span>{{$booking->chambre->nameR }}</span>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h6>
                            <strong>Brief Room description</strong>
                        </h6>
                        <span>{{$booking->chambre->descriptionR }}</span>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <span>
                            <a href="https://www.api2pdf.com">https://www.togetherhostel.com</span>
                    </td>
                </tr>
